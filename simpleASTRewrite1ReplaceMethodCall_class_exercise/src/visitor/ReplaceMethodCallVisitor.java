...
//   private static String CLASSNAME_STR = "String";
//   private static String METHODNAME_TRIM = "trim";
//
//   private static String PKGNAME_UTILSTR = "pkg";
//   private static String CLASSNAME_UTILSTR = "UtilStr";
//   private static String METHODNAME_UTILSTR = "trim";
   
   
   public static String CLASSNAME_STR = "";
   public static String METHODNAME_TRIM = "";
   public static String PKGNAME_UTILSTR = "";
   public static String CLASSNAME_UTILSTR = "";
   public static String METHODNAME_UTILSTR = "";
   ...
   ExpressionStatement createNewStmt(MethodInvocation miExpr) {
      ...
      newMethodInvocation.setExpression(newQualifiedName /* YOUR_ANSWER */);
      ...
      if (objName instanceof SimpleName) {
         ...
         SimpleName newSimpleName = this.astCUnit.newSimpleName(n.getIdentifier()); /* this.astCUnit.YOUR_ANSWER(n.getIdentifier()); */
