...
public class DeclarationVisitorClassEx extends ASTVisitor {
   ...
   GNode createGNode(ASTNode astNode, String nodeName) {
      ...
      if (astNode instanceof TypeDeclaration) {
    	  ...
    	  TypeDeclaration myNode = (TypeDeclaration) astNode;
   	   	  int modifiers = myNode.getModifiers();
   ...
   private String getLabel(GNode srcGNode, GNode dstGNode, ASTNode astNode) {
      // TODO: Class Exercise
       ...
       if (srcGNode instanceof GPackageNode&&
          ...
          astNode instanceof TypeDeclaration) {
    	   ...
    	   String str = UtilNode.getTypeModifier(astNode);
      ...
      // TODO: Class Exercise
       if (srcGNode instanceof GClassNode &&
          ...
          return UtilNode.getMethodModifier(astNode);
       }
      return null;
   }
}
