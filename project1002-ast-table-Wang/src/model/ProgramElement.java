...
public class ProgramElement {
   ...
   private Integer startPosion;

   public ProgramElement() {
   }

   public ProgramElement(String pkgName, String className, String methodName, boolean isRetVoid, int parmSize, int startPostion) {
      this.pkgName = pkgName;
      this.className = className;
      this.methodName = methodName;
      this.isReturnVoid = isRetVoid;
      this.parameterSize = parmSize;
      this.startPosion = startPostion;
   }
   ...
   public Integer getStartPosion() {
	return startPosion;
}

public void setStartPosion(Integer startPosion) {
	this.startPosion = startPosion;
}
